...
$outKeyFile1 = [System.IO.Path]::Combine($outputPath, "imkey.pem")
...
try {
	...
	& $openSSL req -new -config $targetConfig -key $outKeyFile1 -out $outRequestFile -passin file:impwd
